...
body[data-dsh-qingxiao]:not([data-ds-dark-theme]) {
	--dsw-alias-label-secondary: #39454f;
	--dsw-alias-label-tertiary: #5a6672;
}
body[data-dsh-qingxiao][data-ds-dark-theme] {
...
body[data-dsh-qingxiao][data-qx-contrast='on'] [id=root] {
	text-shadow: 0 0 1px rgba(var(--qx-panel-rgb), 0.9), 0 0 3px rgba(var(--qx-panel-rgb), 0.6), 0 0 6px rgba(var(--qx-panel-rgb), 0.35);
}
